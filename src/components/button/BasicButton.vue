<template lang="pug">
//- 基礎按鈕
Button.border-none.h-auto(:class='[bgClass, textClass, paddingClass, borderClass, cornerClass, alignClass]', :style='[bgStyle, textStyle]', :disabled='disabled', :loading='loading')
  slot
</template>
