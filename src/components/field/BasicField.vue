  ...
  .grid.items-center.bg-field.rounded(:class='[gridTemplateColumns, border]')
    ...
    slot(name='left')
      .flex.flex-row.items-center(v-if='iconLeft')
        ...
        .w-px.h-6.bg-primary.opacity-20

    //- 輸入框
    Field.px-4.py-3.bg-transparent(:type='type', :modelValue='value', :placeholder='placeholder', :error='errorVisible', @update:modelValue='handleUpdateValue')
