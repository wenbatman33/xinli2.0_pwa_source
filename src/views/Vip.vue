  ...
  PullRefresh(:model-value='refreshing', @refresh='handleRefresh')
    ...
    .flex.flex-col.flex-grow.items-stretch.pb-28
      ...
      .flex.flex-row.flex-nowrap.items-stretch.mt-4.px-4.overflow-x-auto
        ...
        //- VIP6 生日禮品
        RewardItem(:level='currentLevel', type='gold', :bg='iconVipGiftBg', :name='t("vip_rewardBirthday")', :icon='iconVipGiftDark', :image='iconVipGiftwhite', :status='-99')
...
<script setup lang="ts">
  ...
  const refreshing = computed(() => {
    return getVipDataLoading.value || getVipGiftLoading.value || getVipLevelListLoading.value;
  });
