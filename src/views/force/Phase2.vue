...
.flex.flex-col.flex-grow.justify-between.items-center.pb-20
  ...
  .flex.flex-col.items-stretch.w-80.pt-12.z-20
    ...
    //- 手機
    BasicField.mt-8(v-model:value='phone', :iconLeft='iconMobileWhite70', :placeholder='t("force_phase2_phone")')

    //- 驗證碼
    BasicField.mt-8(v-model:value='captcha', :iconLeft='iconShieldCheckedWhite70', :placeholder='t("force_phase2_captcha")')
      template(#right)
